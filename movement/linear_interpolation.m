function task_list = linear_interpolation(coord1, coord2, num_points)
    ...
    task_list = [twos_list, x_values, y_values, z_values, zero_list]; % Each row represents a point [x, y, z]
